...
public sealed class QuestionModelConfiguration : IEntityTypeConfiguration<QuestionModel>
{
    ...
    public void Configure(EntityTypeBuilder<QuestionModel> builder)
    {
        ...
        builder.HasIndex(question => question.UserId)
            .IsUnique()
            .HasFilter("\"AnsweredAt\" IS NULL");
        builder.HasIndex(question => new { question.UserId, question.ContextFingerprint })
            .IsUnique();
        ...
        builder.Property(question => question.QuestionTranslation)
            .HasMaxLength(500)
            .IsRequired()
        ...
        builder.Property(question => question.AlternativeTranslations)
            .HasColumnType("text[]")
            .IsRequired()
            .HasComment("Traduções em português das cinco alternativas, na mesma ordem das alternativas.");
        builder.Property(question => question.CorrectAlternativeIndex)
            .IsRequired()
            .HasComment("Índice de 1 a 5 da alternativa correta.");
        builder.Property(question => question.SubmittedAlternativeIndex)
