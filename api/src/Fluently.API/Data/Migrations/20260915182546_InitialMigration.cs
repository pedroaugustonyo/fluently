        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Proficiency = table.Column<int>(type: "integer", nullable: true, comment: "1 = A1; 2 = A2; 3 = B1; 4 = B2; 5 = C1; 6 = C2"),
                    Bio = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true, comment: "Biografia utilizada como contexto para gerar questões personalizadas."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionTranslation = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "Tradução para português da frase apresentada na questão."),
                    ...
                    AlternativeTranslations = table.Column<string[]>(type: "text[]", nullable: false, comment: "Traduções em português das cinco alternativas, na mesma ordem das alternativas."),
                    CorrectAlternativeIndex = table.Column<int>(type: "integer", nullable: false, comment: "Índice de 1 a 5 da alternativa correta."),
                    BaseXp = table.Column<int>(type: "integer", nullable: false, defaultValue: 15),
                    SubmittedAlternativeIndex = table.Column<int>(type: "integer", nullable: true, comment: "Índice de 1 a 5 da alternativa selecionada pelo usuário."),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Questions_CorrectAlternativeIndex", "\"CorrectAlternativeIndex\" BETWEEN 1 AND 5");
                    table.CheckConstraint("CK_Questions_StreakAfterAnswer", "\"StreakAfterAnswer\" IS NULL OR \"StreakAfterAnswer\" >= 0");
                    table.CheckConstraint("CK_Questions_SubmittedAlternativeIndex", "\"SubmittedAlternativeIndex\" IS NULL OR \"SubmittedAlternativeIndex\" BETWEEN 1 AND 5");
                    table.ForeignKey(
